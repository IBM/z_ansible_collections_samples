...
After above steps, you will get one ready OpenShift Container Platform on ICIC infrastructure. 
- [Day2 Operation](#day2-operation)
- [Uninstall OpenShift Container Platform](#uninstall-openshift-container-platform)
...
- **(Required)** Linux server, the machine that runs Ansible.
    - Tested on RHEL8.
    - Ansible >= 2.8
...
### 3. Setting ICIC environment variables on your linux server
...
#### Any above steps failed ,you need clean up environment and then rerun the installation steps.
...
## Uninstall OpenShift Container Platform
