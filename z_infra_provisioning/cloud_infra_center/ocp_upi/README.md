...
| `storage_name_prefix`           | \<storage-node-name\>                           | The name and hostname of the storage nodes, such as `ocp4zks`. If defined, exactly **3** storage nodes will be created (`os_storage_nodes_number` is automatically set to 3). If not defined, no storage nodes are created.                                                                                                                                                                                                                                                                                                                                                                                                              |
| `infra_name_prefix`             | \<infra-node-name\>                             | The name and hostname of the infra nodes, such as `ocp4zki`. If defined, exactly **3** infra nodes will be created (`os_infra_nodes_number` is automatically set to 3). If not defined, no infra nodes are created.                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| `os_storage_ip`           | \<storage ip list\>                                     | `[x.x.x.x, x.x.x.x, x.x.x.x]`, <br>**required** when `auto_allocated_ip` is false and `storage_name_prefix` is defined                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `os_infra_node_ip`        | \<infra node ip list\>                                  | `[x.x.x.x, x.x.x.x, x.x.x.x]`, <br>**required** when `auto_allocated_ip` is false and `infra_name_prefix` is defined                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `os_flavor_storage`       | `os_flavor_worker`                                      | OpenStack flavor for storage nodes. If not set, defaults to `os_flavor_worker`. Get available flavors with `openstack flavor list`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `os_flavor_infra`         | `os_flavor_worker`                                      | OpenStack flavor for infra nodes. If not set, defaults to `os_flavor_worker`. Get available flavors with `openstack flavor list`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `add_secgroups`           | \<additional security group\>                           | Additional security group to attach to **all** node ports (bootstrap, master, worker, storage, infra). Comma-separated list of security group names/IDs.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `bootstrap_secgroups`     | \<bootstrap-only security group\>                       | Additional security group(s) to attach to the **bootstrap** port only, on top of `os_sg_master` (and `add_secgroups` if defined). Useful when the bootstrap node requires extra access rules not needed by master nodes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
